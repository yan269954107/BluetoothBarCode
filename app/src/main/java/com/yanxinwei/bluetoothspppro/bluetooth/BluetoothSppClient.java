package com.yanxinwei.bluetoothspppro.bluetooth;
...
public final class BluetoothSppClient extends BTSerialComm{
	...
	/**
	 * 设置发送时的字符串模式
	 * @param bOutputMode bOutIO_Mode 输出io模式 IO_MODE_HEX / IO_MODE_STRING
	 * @return void
	 * */
	...
	/**
	 * 设置处理字符集(默认为UTF-8)
	 * @param sCharset 设置字符集 GBK/GB2312
	 * @return void
	 * 此设置仅对ReceiveStopFlg()与Send()函数有效
	 * */
