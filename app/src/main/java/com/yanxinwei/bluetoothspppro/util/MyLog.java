...
/**
 * MyLog
 * Created by yanxinwei on 16/9/26.
 */
...
public class MyLog {
    ...
    private static int SDCARD_LOG_FILE_SAVE_DAYS = 7;// sd卡中日志文件的最多保存天数g
     ...
     * @return
     **/
    private synchronized static void writeLogtoFile(final String mylogtype, final String tag, final String text) {// 新建或打开日志文件
